...
- (void)viewDidLoad {
    ...
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.00 green:0.48 blue:1.00 alpha:1.0];
...
//        self.enterButton.layer.borderColor = [UIColor whiteColor].CGColor;
        ...
        [self.enterButton setImage:[UIImage imageNamed:@"start"] forState:UIControlStateNormal]; // start button
