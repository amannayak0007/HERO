...
//    }
    ...
    fileprivate func setupCell(_ cell: ChatMessageCell, message: Message) {
        ...
        if message.fromId == FIRAuth.auth()?.currentUser?.uid {
            ...
            //incoming gray
            cell.bubbleView.backgroundColor = UIColor(red: 0.898, green: 0.898, blue: 0.898, alpha: 1.0)
    ...
    func handleSend() {
        if(inputContainerView.inputTextField.text == ""){
            ...
            inputContainerView.inputTextField.text = nil //clears text after hitting Enter
    ...
    fileprivate func sendMessageWithProperties(_ properties: [String: AnyObject]) {
        ...
        let displayName = self.loggedInUserData!["displayName"] as? String
        
        var values: [String: AnyObject] = ["toId": toId as AnyObject, "fromId": fromId as AnyObject, "timestamp": timestamp, "displayName": displayName as AnyObject]
