...
- (void)viewDidLoad {
    ...
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.11 green:0.93 blue:0.35 alpha:1.0];
...
//        self.enterButton.layer.borderColor = [UIColor whiteColor].CGColor;
        ...
        [self.enterButton setImage:[UIImage imageNamed:@"start"] forState:UIControlStateNormal];
